...
Server:	servertoken	{/*Struktur anlegen*/
										...
										} linetoken {$$=$<serverstructlistpointer>2} Configuration endtoken servertoken
					linetoken	{/*Struktur pruefen*/
											printss($<serverstructlistpointer>2);$$=$<serverstructlistpointer>2;
										}
